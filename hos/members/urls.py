...
from hos.members.models import *
...
urlpatterns = patterns('',
    ...
    (r'^history/$', 'hos.members.views.members_history'),
    ...
    (r'^collection/$', 'hos.members.views.members_bankcollection_list'),
    (r'^(?P<user_username>\w+)/$', 'hos.members.views.members_details'),
    (r'^(?P<user_username>\w+)/update/userpic/$',
     'hos.members.views.members_update_userpic'),
    (r'^(?P<user_username>\w+)/update/(?P<update_type>\w+)/$',
     'hos.members.views.members_update'),
)
